...
class Testimoni extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['page_subtitle'] = 'Kelola testimoni dari pengguna Desa Terpadu';
    ...
    public function create()
    {
        ...
        $data['page_subtitle'] = 'Buat testimoni baru';
        $data['action']        = 'create';
        $data['item']          = null;
    ...
    public function detail($id)
    {
        ...
        $data['name']          = $this->session->userdata('name');
        $data['page_title']    = 'Detail Testimoni';
        $data['page_subtitle'] = 'Lihat detail testimoni';
        $data['item']          = $item;
    ...
    public function edit($id)
    {
        ...
        $data['page_subtitle'] = 'Perbarui testimoni';
        $data['action']        = 'edit';
        $data['item']          = $item;

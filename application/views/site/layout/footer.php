        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
            ...
            <div class="flex flex-col items-start md:items-start">
                ...
                <div class="flex gap-3 mt-2">
                    ...
                    <!-- WhatsApp -->
                    <a href="https://api.whatsapp.com/send/?phone=6285172238883&text=Halo+Desa+Terpadu%2C+saya+ingin+mendapatkan+info+penawaran+Aplikasi+Desa+Terpadu.&type=phone_number&app_absent=0" target="_blank" class="w-10 h-10 rounded-full bg-white flex items-center justify-center hover:bg-gray-100 transition">
                        <svg class="w-5 h-5 text-[#883a3a]" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

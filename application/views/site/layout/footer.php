        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
            ...
            <div class="flex flex-col items-start md:items-start">
                <div class="flex items-center gap-4 mb-4">
                    <a href="<?= base_url('home'); ?>" class="flex items-center gap-2 shrink-0">
                        <img src="<?= !empty($site_logo) ? $site_logo : base_url('assets/logo2.png'); ?>" 
                             alt="Desa Terpadu" 
                ...
                <div class="flex gap-3 mt-2">
                    ...
                    <!-- Facebook -->
                    <a href="https://www.facebook.com/people/Desa-Terpadu/61579853082004/"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="w-10 h-10 rounded-full bg-white flex items-center justify-center hover:bg-gray-100 transition">
                        <svg class="w-5 h-5 text-[#883a3a]" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                    </a>
                    <!-- WhatsApp (dinamis dari nomor telepon) -->
                    <a href="https://api.whatsapp.com/send/?phone=<?= preg_replace('/[^0-9]/', '', $contact->phone); ?>" target="_blank" class="w-10 h-10 rounded-full bg-white flex items-center justify-center hover:bg-gray-100 transition">
            ...
            <!-- Kolom 3: Contact (hanya telepon & email) -->
            <div>
                ...
                <div class="flex flex-col gap-3 text-sm md:text-base">
                    <div class="flex items-center gap-3">
                        ...
                        <span><?= html_escape($contact->phone); ?></span>
                    </div>
                    <div class="flex items-center gap-3">
                        ...
                        <span><?= html_escape($contact->email); ?></span>
                    </div>
                </div>
            </div>
        </div>

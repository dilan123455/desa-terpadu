<style>
    /* Warna custom yang sama persis dengan gambar */
    .bg-footer {
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
            ...
            <div class="flex flex-col items-start md:items-start">
                <div class="flex items-center gap-4 mb-4">
                    <!-- Logo Placeholder (Icon Gunung) -->
                    <div class="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center border-2 border-white overflow-hidden">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 15l6-6 4 4 6-6M21 15l-6-6-4 4-6-6"></path>
                        </svg>
                    </div>
                    <h2 class="text-2xl font-bold">Desa Terpadu</h2>
                </div>
                
                <!-- Sosial Media Icons -->
                <div class="flex gap-3 mt-2">
                    <!-- Instagram -->
                    <a href="#" class="w-10 h-10 rounded-full bg-white flex items-center justify-center hover:bg-gray-100 transition">
                        <svg class="w-5 h-5 text-[#883a3a]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Facebook -->
                    <a href="#" class="w-10 h-10 rounded-full bg-white flex items-center justify-center hover:bg-gray-100 transition">
                        <svg class="w-5 h-5 text-[#883a3a]" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

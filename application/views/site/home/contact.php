...
<section id="contact" class="w-full bg-white py-16 sm:py-24">
    <div class="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-16 border-2 border-gray-200 rounded-2xl overflow-hidden transition-all duration-300 hover:border-gray-300">
            ...
            <iframe
                src="https://www.google.com/maps?q=Gg.%20VI%20No.15,%20Sidakarya,%20Denpasar,%20Bali&output=embed"
                width="100%"
                height="400"
                style="border:0;"
                allowfullscreen=""
...
<script>
    ...
    function showContactToast(message) {
        ...
        const toast =
            document.getElementById('ctc-toast');

        const toastMessage =
            document.getElementById('ctc-toast-message');

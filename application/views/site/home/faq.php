            ...
            <div class="space-y-3">
                ...
                <div class="faq-item bg-white border border-gray-200 rounded-sm cursor-pointer transition hover:border-gray-400">
                    <div class="flex items-center px-5 py-4">
                        ...
                        <span class="text-[#404040] font-medium">Pertanyaan 1?</span>
                    </div>
                    <div class="faq-answer hidden px-5 pb-4 text-gray-600 text-sm border-t border-gray-100 mt-1 pt-3">
                        Ini adalah jawaban untuk pertanyaan pertama.
                    </div>
                </div>
                ...
                <div class="faq-item bg-white border border-gray-200 rounded-sm cursor-pointer transition hover:border-gray-400">
                    <div class="flex items-center px-5 py-4">
                        <span class="faq-icon text-sm font-bold text-gray-700 mr-3 transition-transform duration-200">&rsaquo;</span>
                        <span class="text-[#404040] font-medium">Pertanyaan 2?</span>
                    </div>
                    <div class="faq-answer hidden px-5 pb-4 text-gray-600 text-sm border-t border-gray-100 mt-1 pt-3">
                        Ini adalah jawaban untuk pertanyaan kedua.
                    </div>
                </div>
                ...
                <div class="faq-item bg-white border border-gray-200 rounded-sm cursor-pointer transition hover:border-gray-400">
                    <div class="flex items-center px-5 py-4">
                        <span class="faq-icon text-sm font-bold text-gray-700 mr-3 transition-transform duration-200">&rsaquo;</span>
                        <span class="text-[#404040] font-medium">Pertanyaan 3?</span>
                    </div>
                    <div class="faq-answer hidden px-5 pb-4 text-gray-600 text-sm border-t border-gray-100 mt-1 pt-3">
                        Ini adalah jawaban untuk pertanyaan ketiga.
                    </div>
                </div>
                ...
                <div class="faq-item bg-white border border-gray-200 rounded-sm cursor-pointer transition hover:border-gray-400">
                    <div class="flex items-center px-5 py-4">
                        <span class="faq-icon text-sm font-bold text-gray-700 mr-3 transition-transform duration-200">&rsaquo;</span>
                        <span class="text-[#404040] font-medium">Pertanyaan 4?</span>
                    </div>
                    <div class="faq-answer hidden px-5 pb-4 text-gray-600 text-sm border-t border-gray-100 mt-1 pt-3">
                        Ini adalah jawaban untuk pertanyaan keempat.
                    </div>
                </div>
            </div>
        </section>

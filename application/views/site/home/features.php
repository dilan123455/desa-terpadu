...
<head>
    ...
    <title>Fitur - Desa Terpadu</title>
    ...
    <style>
        ...
        /* Garis bawah untuk tab aktif/desktop */
        .tab-button::after {
            content: "";
            position: absolute;
            left: 0;
        ...
        /* Rotasi ikon + saat menu mobile dibuka */
        .mobile-icon {
...
<body class="bg-white">
    ...
    <!-- DIPERBAIKI: Tinggi section disesuaikan agar tidak terlalu pendek -->
    <section class="relative bg-[#cc4b4d] min-h-[1000px] md:min-h-[1300px] lg:min-h-[1500px] overflow-hidden pt-20 pb-48 md:pb-64">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6">
            ...
            <div class="mt-14 md:mt-16 flex flex-col md:flex-row md:flex-wrap justify-center items-center gap-4 md:gap-8 w-full">
                ...
                <!-- 2. Konten Web App (order-2 di Mobile, order-4 di Desktop) -->
                <div id="web" class="tab-content w-full order-2 md:order-4">
                    ...
                    <div class="mt-10 md:mt-14 flex justify-center">
                        <img src="https://desaterpadu.id/wp-content/uploads/2025/08/core-mockup.png"
                             alt="Dashboard Web App Desa Terpadu"
                    ...
                    <div class="mt-10 md:mt-14 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-8 md:gap-y-10">
                        <!-- Isi Grid Web App (Data Warga, Layanan Digital, dll) -->
                ...
                <!-- 3. Menu Anjungan Mandiri (order-3 di Mobile, order-2 di Desktop) -->
                ...
                <!-- 4. Konten Anjungan Mandiri (order-4 di Mobile, order-4 di Desktop) -->
                <div id="anjungan" class="tab-content w-full order-4 md:order-4 hidden">
                    ...
                    <!-- GAMBAR TABLET ANJUNGAN -->
                    <div class="mt-10 md:mt-14 flex justify-center">
                        <img src="https://desaterpadu.id/wp-content/uploads/2025/08/tablet-mockup.png"
                            alt="Anjungan Mandiri Desa Terpadu"
                            class="feature-image w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg rounded-2xl">
                    </div>

                    <!-- GRID FITUR ANJUNGAN MANDIRI -->
                    <div class="mt-10 md:mt-14 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-8 md:gap-y-10">
                ...
                <!-- 5. Menu Mobile App (order-5 di Mobile, order-3 di Desktop) -->
                ...
                <!-- 6. Konten Mobile App (order-6 di Mobile, order-4 di Desktop) -->
                <div id="mobile" class="tab-content w-full order-6 md:order-4 hidden">
                    ...
                    <!-- GAMBAR MOCKUP HP -->
                    <div class="mt-10 md:mt-14 flex justify-center">
                        <img src="https://desaterpadu.id/wp-content/uploads/2025/08/mobile-mockup.png"
                            alt="Mobile App Desa Terpadu"
                            class="feature-image w-full max-w-[140px] sm:max-w-[160px] md:max-w-[180px] lg:max-w-[200px] rounded-3xl shadow-xl">
                    </div>

                    <!-- GRID FITUR MOBILE APP -->
                    <div class="mt-10 md:mt-14 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-8 md:gap-y-10">
                        
                        <!-- 1. Pendataan Langsung -->
                        <div class="flex flex-row items-start gap-3 text-left">
                            <div class="bg-white rounded-2xl p-2 w-12 h-12 md:w-14 md:h-14 flex-shrink-0 flex items-center justify-center shadow-sm">

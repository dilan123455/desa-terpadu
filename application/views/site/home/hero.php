...
<section  id="hero" class="relative bg-[#cc4b4d] min-h-[160vh] flex flex-col items-center justify-start pt-24 pb-0 overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-3xl mx-auto px-6 text-center">
        <img src="<?= base_url('assets/css/gambar_pc.png'); ?>" alt="Desa Terpadu" loading="lazy" class="w-full h-auto object-contain drop-shadow-2xl">
    </div>
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto px-6 text-center mt-8">
        ...
        <button class="bg-[#e0c391] hover:bg-[#d4af6a] text-[#3a1f1f] font-bold text-xl px-10 py-4 rounded-lg shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl active:scale-95">
...
<section class="relative bg-white pt-1 pb-24 -mt-1">

...
<!-- 1. Background merah (Ubah pt-20 menjadi pt-24 agar aman dari navbar fixed) -->
<section class="relative bg-[#cc4b4d] min-h-[160vh] flex flex-col items-center justify-start pt-24 pb-0 overflow-hidden">

    <!-- 2. Gambar -->
    <div class="relative z-10 w-full max-w-3xl mx-auto px-6 text-center">
        <img
            src="<?= base_url('assets/css/gambar_pc.png'); ?>"
            alt="Desa Terpadu"
            loading="lazy"
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto px-6 text-center mt-8">
        <p class="text-white tracking-wide text-xl md:text-2xl mb-4">
            #PelayananDalamGenggaman
        </p>
        <h1 class="text-white font-bold leading-tight text-3xl sm:text-4xl md:text-5xl mb-6">
            Layanan Desa Modern, Mudah dan Terintegrasi
        </h1>
        <p class="text-white/90 text-xl md:text-2xl max-w-3xl mx-auto mb-10 leading-relaxed">
            Solusi lengkap yang menghubungkan perangkat desa, warga, dan layanan
            publik dalam satu ekosistem digital.
        </p>
        <button
            id="cta-explore"
            class="bg-[#e0c391] text-[#3a1f1f] font-bold text-xl px-10 py-4 rounded-lg shadow-lg transition-all duration-300 ease-out"
        >
    ...
    <!-- 4. Wave SVG -->
    <svg class="absolute bottom-0 left-0 w-full h-20 md:h-auto pointer-events-none block"
...
<!-- 5. Section: Tantangan Desa Saat Ini -->
<section id="challenge-section" class="relative bg-white pt-1 pb-24 -mt-1">
    <div class="max-w-6xl mx-auto px-4 md:px-6 text-center">
        ...
        <p class="text-black text-base md:text-lg max-w-4xl mx-auto mb-16 leading-relaxed">
            Tahukah Anda? Rata-rata perangkat desa menghabiskan berjam-jam tiap hari hanya
            untuk administrasi manual yang bisa selesai dalam hitungan menit dengan sistem digital.
        </p>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-14">
            ...
            <div class="flex flex-col items-center px-1 reveal group">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-700 text-lg md:text-xl font-medium leading-snug">
                        Administrasi manual<br>yang lambat dan rumit
                    </p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center px-1 reveal group">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-700 text-lg md:text-xl font-medium leading-snug">
                        Kesulitan Akses Layanan<br>bagi Masyarakat
                    </p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center px-1 reveal group">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-700 text-lg md:text-xl font-medium leading-snug">
                        Data tidak akurat dalam<br>mengambil keputusan
                    </p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center px-1 reveal group">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-700 text-lg md:text-xl font-medium leading-snug">
                        Banyak proses untuk<br>tracing data
                    </p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center px-1 reveal group">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-700 text-lg md:text-xl font-medium leading-snug">
                        Data penduduk tidak<br>tersimpan dengan baik
                    </p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center px-1 reveal group">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-700 text-lg md:text-xl font-medium leading-snug">
                        Akses internet yang<br>merata antar desa
                    </p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center px-1 reveal group">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-700 text-lg md:text-xl font-medium leading-snug">
                        Keterbatasan SDM &amp;<br>infrastruktur pendukung
                    </p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center px-1 reveal group">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-700 text-lg md:text-xl font-medium leading-snug">
                        Keamanan data &amp; privasi<br>yang belum terjamin
                    </p>
                </div>
            </div>
...
<script>
    ...
    ctaButton.addEventListener('mouseenter', () => {
        ctaButton.classList.add('scale-105', 'shadow-2xl');
        ctaButton.classList.remove('bg-[#e0c391]');
        ctaButton.style.backgroundColor = '#d4af6a';
    });
    ctaButton.addEventListener('mouseleave', () => {
        ctaButton.classList.remove('scale-105', 'shadow-2xl');
        ctaButton.style.backgroundColor = '';
        ctaButton.classList.add('bg-[#e0c391]');
    });

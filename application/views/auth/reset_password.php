    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="px-8 py-8">
                ...
                <p class="text-gray-500 text-sm mb-6">Silakan buat password baru untuk akun Desa Terpadu Anda.</p>
                ...
                <?php if (!empty($error)): ?>
                    ...
                    <div class="text-center mt-6">
                        <a href="<?= site_url('auth/forgot_password'); ?>" class="text-sm text-[#cc4b4d] hover:underline font-medium">
                ...
                <?php else: ?>
                    ...
                    <!-- Form -->
                    <form action="<?= site_url('auth/update_password'); ?>" method="post" id="resetForm">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    required
                                    class="w-full pr-12 pl-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#cc4b4d] focus:border-transparent transition"
                                >
                                <button
                                    type="button"
                                    id="togglePassword"
                            ...
                            <p class="text-xs text-gray-400 mt-2">Password minimal 8 karakter.</p>
                        </div>

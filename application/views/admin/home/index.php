...
<div class="admin-wrapper">
    ...
    <div class="ml-0 lg:ml-64">
        ...
        >
            ...
            <div>
                ...
                <p class="text-sm text-gray-400 mt-1">
                    Kelola tampilan halaman utama Desa Terpadu
                </p>
        ...
        <!-- CONTENT -->
        <main
            class="p-4 sm:p-8 pt-24 sm:pt-28"
        >
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Kelola bagian Hero dan Tantangan Desa
                    yang tampil pada halaman utama website.
                </p>
            ...
            >
                ...
                >
                    ...
                    <?php if (!empty($hero)): ?>
                        ...
                        <a
                            href="<?= site_url('admin/home/edit-hero'); ?>"
    ...
    <a
        href="<?= site_url('admin/home/create-challenge'); ?>"
        class="inline-flex
               items-center
               justify-center
               px-4 py-2

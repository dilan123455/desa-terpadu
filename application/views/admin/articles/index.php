                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-shrink-0">
                                            <?php if (!empty($article->image)): ?>
                                                <img class="w-20 h-14 object-cover rounded-lg border border-gray-200"
                                                     src="<?= base_url('assets/uploads/' . $article->image); ?>"
                                                     alt="<?= html_escape($article->title); ?>">
                                            <?php else: ?>
                                                <div class="w-20 h-14 flex items-center justify-center bg-gray-50 text-gray-400 border border-gray-200 rounded-lg text-[10px] text-center">
                                                    Tidak ada gambar
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-start justify-between gap-2">
                                                ...
                                                <span class="shrink-0 text-xs font-semibold px-2 py-1 rounded-full <?= $article->status === 'published' ? 'bg-green-50 text-green-700' : 'bg-orange-50 text-orange-700'; ?>">
                                                    <?= $article->status === 'published' ? 'Published' : 'Draft'; ?>
                                                </span>
                                            </div>

                                            <div class="mt-1 text-xs text-gray-500">
                                                <span class="font-medium text-gray-600"><?= html_escape($article->category); ?></span>
                                                &bull;
                                                <?php
                                    ...
                                    <?php foreach ($articles as $article): ?>
                                        <tr class="hover:bg-red-50/50 transition">
                                            ...
                                            <td class="px-4 py-3.5 align-middle">
                                                <?php if (!empty($article->image)): ?>
                                                    <img class="w-[75px] h-[52px] object-cover rounded-lg border border-gray-200"
                                                         src="<?= base_url('assets/uploads/' . $article->image); ?>"
                                                         alt="<?= html_escape($article->title); ?>">
                                                <?php else: ?>

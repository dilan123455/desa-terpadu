                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-shrink-0">
                                            <?php if (!empty($row->photo)): ?>
                                                <img src="<?= base_url('uploads/testimoni/' . $row->photo); ?>"
                                                    ...
                                                    class="w-14 h-14 object-cover rounded-full border-2 border-gray-200">
                                            <?php else: ?>
                                                <span class="w-14 h-14 rounded-full bg-gray-100 border border-gray-200 flex items-center justify-center text-gray-400 text-xs">
                                                    —
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-start justify-between gap-2">
                                                ...
                                                <span class="shrink-0 text-xs font-semibold px-2 py-1 rounded-full <?= $row->status === 'active' ? 'bg-green-50 text-green-700' : 'bg-gray-100 text-gray-600'; ?>">

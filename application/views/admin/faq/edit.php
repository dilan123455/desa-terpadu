            ...
            <form action="<?= site_url('admin/faq/update/' . $faq->id); ?>" method="post">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="question" name="question"
                        value="<?= html_escape($faq->question); ?>"
                        required
                ...
                <div class="mb-5">
                    ...
                    <textarea id="answer" name="answer"
                        rows="6"
                        required
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:border-red-500 focus:ring-2 focus:ring-red-100 text-sm resize-y"><?= html_escape($faq->answer); ?></textarea>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <select id="status" name="status"
                        ...
                        <option value="inactive" <?= $faq->status === 'inactive' ? 'selected' : ''; ?>>Tidak Aktif</option>
                    </select>
                </div>

...
<head>
    ...
    <title>Tambah Privacy Policy - Admin</title>
    ...
    <main class="lg:ml-64 min-h-screen">
        ...
        <div class="bg-white border-b border-gray-200">
            <div class="px-6 py-5">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Tambahkan bagian baru pada kebijakan privasi website.
                </p>
            </div>
        </div>
        ...
        <div class="p-6">
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <form action="<?= site_url('admin/privacy_policy/store'); ?>" method="POST">
